...
parser.add_argument('--n_rollout', type=int, default=8, metavar='N',
                    help='number of roll-out (default: 16)')
parser.add_argument('--vocab_size', type=int, default=1615, metavar='N',
...
parser.add_argument('--gen_lr', type=float, default=0.1e-3, metavar='LR',
                    help='learning rate of generator optimizer (default: 1e-3)')
parser.add_argument('--dis_lr', type=float, default=0.1e-3, metavar='LR',
...
#d_filter_sizes = [1, 2, 3, 4, 5, 6,7]
d_filter_sizes = [1, 2, 3, 4 ]


#d_num_filters = [100, 200, 200, 200, 200, 100, 100, 100, 100, 100, 160, 160]
#d_num_filters = [100, 200, 200, 200, 200, 100, 100]
